# Test Results
**Ran 103 Tests (70 Suites) in 1086ms.**
 - Run Date/Time: 2017-03-05T14:21:56.188Z
 - 103 tests passed
 - 0 tests failed
 - 0 tests skipped
...
#### The Engine Class constructor 
   - should create a new Engine instance with EventProxied properties (fps, loading) and standard enumerable properties (scene, running, settings)(11ms) ... OK
...
#### The Engine Class Engine instance run method 
   - should return a promise that initializes the scene with the provided entities, attaches event listeners to the canvas element, and begins the main render/update loop before resolving to self(**508**ms) ... OK
...
#### The Engine Class Engine instance onEvent method 
   - should unconditionally listen to a state event(3ms) ... OK
...
#### The Engine Class Engine instance registerMouseEventsForEntity method 
   - should set the hover cursor for the entity's primary mesh if cursor arugment is provided(0ms) ... OK
...
#### The Entity Class create method Entity object 
   - should have id and uid properties(1ms) ... OK
   - should have a mesh method that returns the component for the _primaryMesh key, if set(0ms) ... OK
   - should have a meshAsync property that is configurable until it's returned promise resolves to the entity mesh once available, then redefining the property to resolve directly to the mesh, and no longer reconfigurable(48ms) ... OK
...
#### StateEventProxy StateProxy exported function (integration tests) 
   ...
   - should assign proxy properties from a map of keys and values to the provided object and emit state events when a property is reassigned(4ms) ... OK
...
#### StateEventProxy StateEventProxy Class emit method 
   ...
   - should not call events.emit if the scope is disabled(0ms) ... OK
...
#### StateEventProxy StateEventProxy Class proxifyProperty method 
   ...
   - should assign to the provided object a deeply-proxied value when the value to be assigned is an array and deep=true(5ms) ... OK
