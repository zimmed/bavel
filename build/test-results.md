# Test Results
**Ran 103 Tests (70 Suites) in 1172ms.**
 - Run Date/Time: 2018-03-01T19:09:21.035Z
 - 103 tests passed
 - 0 tests failed
 - 0 tests skipped
...
#### The Engine Class Engine instance baby getter method 
   - should return the read-only GraphicsLibary Engine instance once mounted(2ms) ... OK
...
#### The Engine Class Engine instance run method 
   - should return a promise that initializes the scene with the provided entities, attaches event listeners to the canvas element, and begins the main render/update loop before resolving to self(**507**ms) ... OK
...
#### The Engine Class Engine instance stop method 
   - should stop the render/update loop if running(1ms) ... OK
...
#### The Engine Class Engine instance toVector method 
   ...
   - should return a new zero vector by default(2ms) ... OK
...
#### The Engine Class Engine instance registerKeyAction method 
   - should register event listeners to fire the handler provided for the key event specified, onKeyUp or onKeyDown(2ms) ... OK
...
#### The Entity Class 
   - should be a class that inherits from Static(1ms) ... OK
...
#### The Entity Class tick method 
   - should call the tick method on the provided entity instance(1ms) ... OK
...
#### PlayerController Class PlayerController instance message method 
   - should functionally update this.messages by adding the new message from the provided data at the front of messages(0ms) ... OK
...
#### StateEventProxy StateProxy exported function (integration tests) 
   - should assign proxy properties from a list of keys to the provided object and emit state events when a property is reassigned(5ms) ... OK
...
#### StateEventProxy StateEventProxy Class emit method 
   ...
   - should not call events.emit if the scope is disabled(1ms) ... OK
...
#### StateEventManager 
   ...
   - should dispatch an event with the emit method and callback the events listener for that event, registered with the on method(0ms) ... OK
