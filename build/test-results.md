# Test Results
**Ran 103 Tests (70 Suites) in 1073ms.**
 - Run Date/Time: 2017-03-05T20:45:52.480Z
 - 103 tests passed
 - 0 tests failed
 - 0 tests skipped
...
#### The Engine Class constructor 
   - should create a new Engine instance with EventProxied properties (fps, loading) and standard enumerable properties (scene, running, settings)(7ms) ... OK
...
#### The Engine Class Engine instance canvas getter method 
   - should return the read-only canvas element once mounted(3ms) ... OK
...
#### The Engine Class Engine instance run method 
   - should return a promise that initializes the scene with the provided entities, attaches event listeners to the canvas element, and begins the main render/update loop before resolving to self(**514**ms) ... OK
...
#### The Entity Class tick method 
   - should call the tick method on the provided entity instance(3ms) ... OK
