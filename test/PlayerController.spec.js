...
import PlayerController, { round } from 'src/PlayerController';
...
describe('PlayerController Class', () => {
    ...
    it(`should be a singleton class`, () => {
        ...
        expect(() => pc = new PlayerController()).to.throw(Error);
    });
    ...
    describe('constructor', () => {
        ...
        beforeEach(() => sandbox.stub(StateEventProxy, 'create'));
        ...
        for messages, player, and target, as well as an engine getter`, () => {
            ...
            expect(StateEventProxy.create.calledWithExactly(ctrl, 'engine.ctrl', [
    ...
    describe('PlayerController instance', () => {
        ...
        describe('setup method', () => {
            ...
            beforeEach(() => sandbox.stub(ctrl, 'registerKeyActions'));
        ...
        describe('registerKeyActions method', () => {
            ...
            beforeEach(() => sandbox.stub(engine, 'registerKeyAction'));
