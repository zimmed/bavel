...
var Engine = function (_Singleton) {
    ...
    _createClass(Engine, [{
        ...
        value: function constructorHelper(loggerService, PlayerController, settings) {
            if (!PlayerController) {
                PlayerController = require('./player-controller').default;
            }
            (0, _stateEventProxy2.default)(this, 'engine', ['fps', 'loading']);
    ...
    _createClass(Engine, [{
            ...
            if (!this.running && this.loading === LoadStates.DATA) {
                ...
                defer = defer.then(function () {
                    ...
                    setInterval(function () {
                        _this4.fps = Math.floor(_this4.baby.fps);
                    }, 500);
                    _this4.running = true;
                    return _this4;
                });
        ...
        value: function onEvent(event, handler) {
            return _stateEvents.Events.on(event, handler);
        }
    }, {
