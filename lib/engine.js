...
if (typeof require.ensure !== 'function') {
    require.ensure = function () {
        var dep = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
        var cb = arguments[1];
        return cb(dep);
    };
}

var ensureAsync = function ensureAsync(deps, chunk) {
    return new Promise(function (res) {
        return require.ensure(deps, res, chunk);
    });
};
...
var Engine = function () {
    ...
    _createClass(Engine, [{
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 2:
                                ...
                                _context.next = 6;
                                return ensureAsync(['babylonjs'], 'graphics');
                        ...
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 6:
                                ...
                                this.statsInterval = setInterval(function () {
                                    _this.fps = Math.floor(_this.baby.fps);
        ...
        value: function () {
            ...
            function registerMouseEventsForEntity(_x8) {
