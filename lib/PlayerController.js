...
var PlayerController = function () {
    _createClass(PlayerController, [{
        ...
        key: 'create',
        value: function create(engine) {
            var Ctrl = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this;
    ...
    function PlayerController(engine) {
        ...
        _StateEventProxy2.default.create(this, 'engine.ctrl', ['messages', 'player', 'target']);
    ...
    _createClass(PlayerController, [{
        ...
        value: function registerKeyActions(keyHandlers) {
            ...
            keyHandlers.forEach(function (desc) {
                _this.engine.registerKeyAction(desc.key, desc);
            });
        }
    }, {
        key: 'message',
